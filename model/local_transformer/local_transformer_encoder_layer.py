...
from model.local_transformer.local_self_attention import LocalSelfAttention
...
class LocalTransformerEncoderLayer(torch.nn.Module):
    ...
    def forward(self, src: torch.Tensor, src_mask: Optional[torch.Tensor] = None,
                src_key_padding_mask: Optional[Tensor] = None, is_causal: Optional[bool] = None) -> torch.Tensor:
